        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Positions_JobId",
                        column: x => x.JobId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PutforwardId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatRecord_AspNetUsers_PutforwardId",
                        column: x => x.PutforwardId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRecord_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PutForwardId = table.Column<int>(type: "int", nullable: false),
                    FunctionaryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FunctionaryId = table.Column<int>(type: "int", nullable: true),
                    PutForwardId = table.Column<int>(type: "int", nullable: true),
                    ProjectId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Missions_AspNetUsers_PutForwardId",
                        column: x => x.PutForwardId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notices_AspNetUsers_PutforwardId",
                        column: x => x.PutforwardId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Risks_AspNetUsers_PutForwardId",
                        column: x => x.PutForwardId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FundChanges", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionExecutors", x => new { x.ApplicationUserId, x.MissionId });
                    table.ForeignKey(
                        name: "FK_MissionExecutors_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionExecutors_Missions_MissionId",
                        column: x => x.MissionId,
                        principalTable: "Missions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoticeReceivers", x => new { x.NoticeId, x.ReceiverId });
                    table.ForeignKey(
                        name: "FK_NoticeReceivers_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoticeReceivers_Notices_NoticeId",
                        column: x => x.NoticeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRecord_PutforwardId",
                table: "ChatRecord",
                column: "PutforwardId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRecord_ReceiverId",
                table: "ChatRecord",
                column: "ReceiverId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionExecutors_MissionId",
                table: "MissionExecutors",
                column: "MissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Missions_PutForwardId",
                table: "Missions",
                column: "PutForwardId");

            migrationBuilder.CreateIndex(
                name: "IX_NoticeReceivers_ReceiverId",
                table: "NoticeReceivers",
                column: "ReceiverId");
