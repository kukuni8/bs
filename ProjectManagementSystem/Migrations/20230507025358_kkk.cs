        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FunctionaryId = table.Column<int>(type: "int", nullable: false),
                    PutForwardId = table.Column<int>(type: "int", nullable: false),
                    DefectProjectId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Defects_Projects_DefectProjectId",
                        column: x => x.DefectProjectId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    MissionProjectId = table.Column<int>(type: "int", nullable: false),
                    PutForwardId = table.Column<int>(type: "int", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Missions_Projects_MissionProjectId",
                        column: x => x.MissionProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUser", x => new { x.ApplicationUserId, x.ProjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Risks_Projects_RiskProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionExecutor", x => new { x.ApplicationUserId, x.MissionId });
                    table.ForeignKey(
                        name: "FK_MissionExecutor_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissionExecutor_Missions_MissionId",
                        column: x => x.MissionId,
                        principalTable: "Missions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Defects_DefectProjectId",
                table: "Defects",
                column: "DefectProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionExecutor_MissionId",
                table: "MissionExecutor",
                column: "MissionId");

            migrationBuilder.CreateIndex(
                name: "IX_Missions_MissionProjectId",
                table: "Missions",
                column: "MissionProjectId");
