    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExecutorsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MissionsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMission", x => new { x.ExecutorsId, x.MissionsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserMission_AspNetUsers_ExecutorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMission_MissionsId",
